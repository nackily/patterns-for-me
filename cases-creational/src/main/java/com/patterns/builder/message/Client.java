...
import com.patterns.builder.message.builder.MailBuilder;
import com.patterns.builder.message.builder.ShortMessageBuilder;
import com.patterns.builder.message.builder.SiteLatterBuilder;
import com.patterns.builder.message.product.Mail;
import com.patterns.builder.message.product.ShortMessage;
