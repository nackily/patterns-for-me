...
## 项目背景
2021年下半年的一个夜里，居家办公的我接到同事打来的电话，电话里他希望我帮他解决一个问题。简而言之就是同事在翻看底层源码时，被里面的复杂关系搞的晕头转向。虽然作者已经使用 Decorator 结尾来表明相关类使用了装饰器模式，但显然我工作四年多的同事并不知道这一点。我问他之前有学习过设计模式吗？他告诉我之前尝试学习过，但书籍里的理论过于深奥，网上的资料又是抄来抄去，慢慢的就放弃了。这样的情况我已经遇到不止一次了，很多有工作经验的同事在面向对象设计能力上的欠缺让我有些惊讶，他们要么不愿意丰富自己，要么就抱怨设计模式是那么隐晦、那么难以理解，以至于他们总是被拒之门外。

2022年3月份，我一个在培训机构授课的朋友希望我写一份 MySQL 和设计模式的课件，钱很少，但我还是把活儿揽了下来。当然，因为这份课件是针对培训生的，所以可以比较简略。尽管这样我还是想得太乐观了，正如我的同事所说，网上有用的资料太少，光是设计模式的课件，我都花费两个月的时间（休息时间和周末）才整理好课件并交付。庆幸的是，在这之前我已经多次通读过《Design Patterns - Elements of Reusable Object-Oriented Software》一书，这也是我揽这份活儿的底气。

课件交付后，我决定对设计模式部分的内容进行丰富，并开源出来。
...
在阅读文档文档之前，你需要了解在类图中我是如何描述类与类之间的关系的。// todo
...
> <br>**难度等级**：★★★★★
> <br>**助记关键词**：过滤器
> <br>[**案例代码**](/src/main/java/com/aoligei/behavioral/chain_of_responsibility)
...
> <br>**难度等级**：★★★★★
> <br>**助记关键词**：封装请求
> <br>[**案例代码**](/src/main/java/com/aoligei/behavioral/command)
...
> <br>**难度等级**：★★★★★
> <br>**助记关键词**：谷歌翻译
> <br>[**案例代码**](/src/main/java/com/aoligei/behavioral/interpreter)
...
> <br>**难度等级**：★★☆☆☆
> <br>**助记关键词**：遍历
> <br>[**案例代码**](/src/main/java/com/aoligei/behavioral/iterator)
...
> <br>**难度等级**：★★★☆☆
> <br>**助记关键词**：中介、消息队列
> <br>[**案例代码**](/src/main/java/com/aoligei/behavioral/mediator)
...
> <br>**难度等级**：★★★☆☆
> <br>**助记关键词**：撤销、回滚
> <br>[**案例代码**](/src/main/java/com/aoligei/behavioral/memento)
...
> <br>**难度等级**：★★★☆☆
> <br>**助记关键词**：你不必找我，我来找你
> <br>[**案例代码**](/src/main/java/com/aoligei/behavioral/observer)
...
> <br>**难度等级**：★☆☆☆☆
> <br>**助记关键词**：上坡加速，下坡减速
> <br>[**案例代码**](/src/main/java/com/aoligei/behavioral/state)
...
> <br>[**案例代码**](/src/main/java/com/aoligei/behavioral/strategy)
...
> <br>[**案例代码**](/src/main/java/com/aoligei/behavioral/template_method)
...
> **流行指数**：★☆☆☆☆
> <br>**难度等级**：★★★★★
> <br>[**案例代码**](/src/main/java/com/aoligei/behavioral/visitor)
...
> <br>**难度等级**：★★★☆☆
> <br>**助记关键词**：全局唯一、工具类
> <br>[**案例代码**](/src/main/java/com/aoligei/creational/singleton)
...
> <br>**难度等级**：★★☆☆☆
> <br>**助记关键词**：细胞分裂
> <br>[**案例代码**](/src/main/java/com/aoligei/creational/prototype)
> <br>**摘要**：用原型实例指定创建对象的种类，并且通过拷贝这些原型创建新的对象...[**查看更多**][prototype_doc]
> <br>
...
> <br>**难度等级**：★★☆☆☆
> <br>**助记关键词**：外卖套餐，车间流水线
> <br>[**案例代码**](/src/main/java/com/aoligei/creational/builder)
...
> <br>**难度等级**：★★★★☆
> <br>**助记关键词**：煤厂产煤，鞋厂造鞋
> <br>[**案例代码**](/src/main/java/com/aoligei/creational/factory_method)
> <br>**摘要**：我们都知道设计模式实际上是一些指导思想，这些指导思想是由前人总结和提炼出来的，主要目的是为了解决在代码设计和维护时暴露出来的问题。这些问题往往围绕着耦合性、扩展性等展开...[**查看更多**][factory_method_doc]
> <br>
...
> <br>**难度等级**：★★★☆☆
> <br>**助记关键词**：主题切换
> <br>[**案例代码**](/src/main/java/com/aoligei/creational/abstract_factory)
...
> <br>[**案例代码**](/src/main/java/com/aoligei/structural/adapter)
...
> <br>[**案例代码**](/src/main/java/com/aoligei/structural/bridge)
...
> <br>**难度等级**：★★☆☆☆
> <br>**助记关键词**：树形结构
> <br>[**案例代码**](/src/main/java/com/aoligei/structural/composite)
...
> <br>**难度等级**：★★★★☆
> <br>**助记关键词**：俄罗斯套娃
> <br>[**案例代码**](/src/main/java/com/aoligei/structural/decorator)
...
> <br>[**案例代码**](/src/main/java/com/aoligei/structural/facade)
...
> <br>**难度等级**：★★★☆☆
> <br>**助记关键词**：对象共享
> <br>[**案例代码**](/src/main/java/com/aoligei/structural/flyweight)
...
> <br>**难度等级**：★★★☆☆
> <br>**助记关键词**：全局唯一、工具类
> <br>[**案例代码**](/src/main/java/com/aoligei/structural/proxy)
...
多看书，看好书。不管处于哪个阶段，温故知新总是没错的。拿《Design Patterns - Elements of Reusable Object-Oriented Software》来说，这本书不像小说，不能在阅读过一遍之后就束之高阁。这本书更适合反复阅读，反复理解，反复消化，因为每一次阅读我们都能有些不一样的感受，也能有些不一样的收货。
